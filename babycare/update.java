...
import java.io.*;
import java.sql.*;
public class update extends JFrame implements MenuListener, ActionListener {
    JPanel panel;
    ...
    public update() {
        ...
        JLabel label = new JLabel("Update Products");
        label.setBounds(1310, 10, 550, 100);
        label.setFont(new Font("Arial", Font.BOLD, 60));
        label.setForeground(Color.decode("#b666d2"));
        panel.add(label);
        JLabel labell = new JLabel("Select Product No:");
        labell.setBounds(1350, 80, 450, 100);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==btn){
            try{
                ...
                int res = state.executeUpdate("update product set pname='"+tb1.getText().toString()+"',pprice="+Integer.parseInt(tb2.getText().toString())+",pinfo='"+tarea.getText().toString()+"',pimg='"+path+"' where pno="+Integer.parseInt(box.getSelectedItem().toString()));
                if(res!=-1){
                    try{
                ...
                JOptionPane.showMessageDialog(null,"File uploaded successfully!","BabyCare Alerts!",JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null,"Product Updated Successfully!","BabyCare Alerts!",JOptionPane.INFORMATION_MESSAGE);    
                    tb1.setText("");
                    tb2.setText("");
                    tarea.setText("");                
                }else{
